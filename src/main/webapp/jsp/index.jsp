    ...
    <div class="site-main clearfix">
                    ...
                    <div class="avatar fl">
                        <c:choose>
                            <c:when test="${student.avatar == null || student.avatar == ''}">
                                <img src="../img/default_headpic.png" alt="">
                            </c:when>
                            <c:otherwise>
        ...
        <div class="base-info-pop">
            <div class="avatar-upload">
                <c:choose>
                    <c:when test="${student.avatar == null || student.avatar == ''}">
                        <img src="../img/default_headpic.png" class="layui-circle" alt="">
                    </c:when>
                    <c:otherwise>
                        <img src="${student.avatar}" class="layui-circle" alt="">
                    </c:otherwise>
                </c:choose>
                <div class="avatar-upbar">
                    <div class="layui-box layui-upload-button">
                        <form target="layui-upload-iframe" method="get" key="set-mine" enctype="multipart/form-data" action="/test/upload.json">
                            <input type="file" name="file" class="layui-upload-file" id="test"></form>
